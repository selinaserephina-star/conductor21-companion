...
**An empirical companion — Selina Stenberg and Ilya Balashov** · v1.1 (2026-09-19) · CC BY 4.0
...
```
paper/            companion.pdf (v1.1), LaTeX source, figures
...
The second author's independent verification covers the theory on which the
...
principles — not a rerun of the measurement campaign; the scripts and data are
released precisely so that any reader can perform that rerun.

## License and citation

CC BY 4.0 (see `LICENSE`). Cite via `CITATION.cff`, or the Zenodo DOI once deposited.
