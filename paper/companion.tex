...
(numerically anchored, PARI): $\chi_3$-pair 15 zeros ($\gamma\le5.31$),
$\chi_6$ 12 ($\le4.85$), $\chi_7$ 10 ($\le4.14$).
...
factorization of $f$ mod $p$); exact $a_p$ for $p\in(10^9,10^{10}]$
...
and the main program record are at \cite{mainpaperdata}. Every number in
this paper is produced by a named script on named data, under CC~BY~4.0.
...
Diophantine Problems, Birkh\"auser (1987), 183--203.
...
Experiment. Math. 3 (1994), 173--197.
...
`Partitio numerorum' III}, Acta Math. 44 (1923), 1--70.
